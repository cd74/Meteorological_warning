...
cfg = __C
__C.GLOBAL = edict()
__C.GLOBAL.DEVICE = torch.device("cuda")#"cuda" if torch.cuda.is_available() else "cpu")
__C.GLOBAL.BATCH_SZIE = 3
...
__C.HKO.BENCHMARK.OUT_LEN = 15  # The maximum output length to ensure that all models are tested on the same set of input data
